        ...
        function i(t, i) {
            ...
            function o() {
                $ && (F.append(e('<div class="jspVerticalBar" />').append(e('<div class="jspCap jspCapTop" />'), e('<div class="jspTrack" />').append(e('<div class="jspDrag" />').append(e('<div class="jspDragTop" />'), e('<div class="jspDragBottom" />'))), e('<div class="jspCap jspCapBottom" />'))), ie = F.find(">.jspVerticalBar"), ne = ie.find(">.jspTrack"), U = ne.find(">.jspDrag"), I.showArrows && (ae = e('<a class="jspArrow jspArrowUp" />').bind("mousedown.jsp", u(0, -1)).bind("click.jsp", M), le = e('<a class="jspArrow jspArrowDown" />').bind("mousedown.jsp", u(0, 1)).bind("click.jsp", M), I.arrowScrollOnHover && (ae.bind("mouseover.jsp", u(0, -1, ae)), le.bind("mouseover.jsp", u(0, 1, le))), c(ne, I.verticalArrowPositions, ae, le)), se = q, F.find(">.jspVerticalBar>.jspCap:visible,>.jspVerticalBar>.jspArrow").each(function () {
                    ...
                    e("html").bind("dragstart.jsp selectstart.jsp", M), U.addClass("jspActive");
                ...
                f(), $ && ne.bind("mousedown.jsp", function (t) {
                    if (void 0 === t.originalTarget || t.originalTarget == t.currentTarget) {
                        var i, n = e(this), o = n.offset(), s = t.pageY - o.top - _, r = !0, a = function () {
                            var e = n.offset(), o = t.pageY - e.top - re / 2, c = q * I.scrollPagePercent,
                                u = Z * c / (V - q);
                    ...
                    if (void 0 === t.originalTarget || t.originalTarget == t.currentTarget) {
                        var i, n = e(this), o = n.offset(), s = t.pageX - o.left - te, r = !0, a = function () {
                            var e = n.offset(), o = t.pageX - e.left - pe / 2, c = O * I.scrollPagePercent,
                                u = ee * c / (N - O);
            ...
            function f() {
                ue && ue.unbind("mousedown.jsp"), ne && ne.unbind("mousedown.jsp")
            }

            function h() {
                e("html").unbind("dragstart.jsp selectstart.jsp mousemove.jsp mouseup.jsp mouseleave.jsp"), U && U.removeClass("jspActive"), J && J.removeClass("jspActive")
            }
            ...
            function Y() {
                ...
                var n, o, s = [];
                K && s.push(ce[0]), $ && s.push(ie[0]), L.bind("focus.jsp", function () {
                    t.focus()
            ...
            var I, L, O, q, F, N, V, G, Q, $, K, U, Z, _, J, ee, te, ie, ne, oe, se, re, ae, le, ce, ue, de, pe, fe, he,
                ve, ge, me, je, be = this, we = !0, ke = !0, ye = !1, xe = !1, De = t.clone(!1, !1).empty(),
