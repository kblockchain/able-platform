...
function buy_token(){
    ...
    var _priceInWei = $('#input_price_token').val();
...
function sell_token(){
    ...
    var _priceInWei = $('#input_price_token2').val();
    var _amount = $('#input_num_token2').val();
...
function get_buy_order_book() {
    ...
    contractInstance.getBuyOrderBook(_token, function (err, res) {
        console.log(res);
    });
}
...
function get_sell_order_book() {
    ...
    contractInstance.getSellOrderBook(_token, function (err, res) {
        console.log(res);
    });
}
