...
contract AblePlatform is Ownable {
     ...
     */
    function getdexAccountBuyCount(bytes32 _accountNumber, address _token) public view returns(uint ableAccountCount) {
     ...
     * @return uint dexAccountOrderCount.
     */
    function getdexAccountSellCount(bytes32 _accountNumber, address _token) public view returns(uint ableAccountCount) {
